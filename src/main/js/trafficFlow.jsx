...
class TrafficFlow extends React.Component {
    ...
    beginSampleData(self) {
        this.traffic = {nodes: [], connections: []};
        request.get(location.protocol + "//" + window.location.hostname + ":8081")
    ...
    updateData(newTraffic) {
        ...
        if (newTraffic) {
            ...
            _.each(newTraffic.connections, (connection) => {
                const existingConnectionIndex = _.findIndex(updatedTraffic.connections, {
            ...
            <div className="vizceral-container">
                { this.state.redirectedFrom ?
                    <Alert onDismiss={this.dismissAlert}>
                        <strong>{this.state.redirectedFrom.join('/') || '/'}</strong> does not exist, you were redirected to
                ...
                <div className="subheader">
                    ...
                    <div style={{float: 'right', paddingTop: '4px'}}>
                        ...
                        <a role="button" className="reset-layout-link"
                           onClick={this.resetLayoutButtonClicked}>Reset Layout</a>
                    </div>
                </div>
